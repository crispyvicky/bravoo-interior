...
export const RoomSelectionSection = (): JSX.Element => {
  return (
    <section className="w-full bg-secondary-05 py-[100px]">
      <div className="container mx-auto px-4">
        <h2 className="font-label-medium font-[number:var(--label-medium-font-weight)] text-primary-01 text-[length:var(--label-medium-font-size)] text-center tracking-[var(--label-medium-letter-spacing)] leading-[var(--label-medium-line-height)] whitespace-nowrap [font-style:var(--label-medium-font-style)] mb-[83px]">
          SHOP BY ROOM
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[1500px] mx-auto">
          {roomData.map((room, index) => (
            <Button
              key={index}
              variant="ghost"
              className={`h-auto p-0 flex items-start gap-2 hover:bg-transparent ${
            ...
            >
              ...
              <span
                className={`font-heading-02 font-[number:var(--heading-02-font-weight)] text-[length:var(--heading-02-font-size)] tracking-[var(--heading-02-letter-spacing)] leading-[var(--heading-02-line-height)] [font-style:var(--heading-02-font-style)] ${
